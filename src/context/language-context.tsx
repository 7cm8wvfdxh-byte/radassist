...
const tr: Record<string, string> = {
    ...
    "forum.unpinPost": "Sabitlemeyi Kaldır",
    "forum.bookmark": "Kaydet",
    "forum.bookmarked": "Kaydedildi",
    "forum.bookmarks": "Kaydedilenler",
    "forum.editPost": "Düzenle",
    "forum.editSuccess": "Gönderi güncellendi.",
    "forum.editFailed": "Gönderi güncellenemedi.",
    "forum.imageUpload": "Görüntü Ekle",
    "forum.imageUploading": "Yükleniyor...",
    "forum.imageUploadFailed": "Görüntü yüklenemedi.",
    "forum.markdownSupported": "Markdown desteklenir",
    "forum.preview": "Önizleme",
    "forum.write": "Yaz",
    "forum.loadMore": "Daha Fazla Yükle",
    "forum.noMore": "Tüm gönderiler yüklendi",
    "forum.notifications": "Bildirimler",
    "forum.noNotifications": "Bildirim yok",
    "forum.notifLiked": "gönderinizi beğendi",
    "forum.notifCommented": "gönderinize yorum yaptı",
    "forum.notifPinned": "gönderinizi sabitledi",
    "forum.markAllRead": "Tümünü okundu işaretle",
    "forum.viewProfile": "Profili Gör",
    "forum.userPosts": "Gönderileri",
    "forum.userComments": "Yorumları",
    "forum.memberSince": "Üyelik",
    "forum.likeComment": "Yorumu beğen",
    "forum.pinnedPosts": "Sabitlenmiş Gönderiler",
...
const en: Record<string, string> = {
    ...
    // Forum Enhanced
    "forum.pinned": "Pinned",
    "forum.pinPost": "Pin Post",
    "forum.unpinPost": "Unpin Post",
    "forum.bookmark": "Save",
    "forum.bookmarked": "Saved",
    "forum.bookmarks": "Saved Posts",
    "forum.editPost": "Edit",
    "forum.editSuccess": "Post updated.",
    "forum.editFailed": "Failed to update post.",
    "forum.imageUpload": "Add Image",
    "forum.imageUploading": "Uploading...",
    "forum.imageUploadFailed": "Failed to upload image.",
    "forum.markdownSupported": "Markdown supported",
    "forum.preview": "Preview",
    "forum.write": "Write",
    "forum.loadMore": "Load More",
    "forum.noMore": "All posts loaded",
    "forum.notifications": "Notifications",
    "forum.noNotifications": "No notifications",
    "forum.notifLiked": "liked your post",
    "forum.notifCommented": "commented on your post",
    "forum.notifPinned": "pinned your post",
    "forum.markAllRead": "Mark all read",
    "forum.viewProfile": "View Profile",
    "forum.userPosts": "Posts",
    "forum.userComments": "Comments",
    "forum.memberSince": "Member since",
    "forum.likeComment": "Like comment",
    "forum.pinnedPosts": "Pinned Posts",
