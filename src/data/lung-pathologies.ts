...
export const lungPathologies: Pathology[] = [
    ...
    },
    {
        ...
        "etiologyEn": "Bacterial: S. pneumoniae (most common community-acquired), H. influenzae, S. aureus, Klebsiella (alcoholics). Atypical: Mycoplasma, Legionella, Chlamydia. Viral: Influenza, RSV, SARS-CoV-2. Risk factors: Advanced age, immunosuppression, COPD, smoking, aspiration.",
        ...
        "differentialDiagnosisEn": ["Pulmonary Edema (Cardiomegaly, bilateral perihilar, cephalization)", "Pulmonary Hemorrhage (Hemoptysis, diffuse GGO, anemia)", "Organizing Pneumonia (COP — peripheral consolidation, reverse halo)", "Eosinophilic Pneumonia (Peripheral consolidation, eosinophilia)", "Lung Cancer (Obstructive pneumonia, persistent infiltrate)"],
        ...
        "goldStandardEn": "Chest X-ray: First-line diagnosis. CT thorax: For complications (abscess, empyema) and differential diagnosis. Sputum culture and blood culture: Pathogen identification.",
        ...
        "clinicalPearlEn": "Lobar consolidation + air-bronchogram + fever = Bacterial pneumonia. If no response to antibiotics within 48-72 hours, obtain CT → investigate for abscess, empyema, or underlying obstructive lesion (tumor).",
    ...
    },
    {
        ...
        "etiologyEn": "Benign: Granuloma (TB, histoplasmosis), hamartoma (most common benign tumor — fat + popcorn calcification), intrapulmonary lymph node. Malignant: Primary lung cancer (adenocarcinoma most common), metastasis, carcinoid tumor. Premalignant: AAH, AIS.",
        ...
        "differentialDiagnosisEn": ["Granuloma (Calcified, stable size, central/lamellar/popcorn calcification)", "Hamartoma (Fat + calcification, smooth margin)", "Metastasis (Multiple, known primary)", "Carcinoid Tumor (Central, vascular enhancement)", "Intrapulmonary Lymph Node (Subpleural, <12mm, lower lobe)"],
        ...
        "goldStandardEn": "Thin-section CT (<=1mm): Nodule morphology and density. PET-CT: Metabolic activity in >8mm solid nodules. Lung-RADS and Fleischner criteria: Follow-up algorithm. Biopsy: For growing or suspicious nodules.",
        ...
        "clinicalPearlEn": "Spiculated margin + growth + PET positivity = Malignant. Stable >2 years + smooth margin + calcification = Benign. If solid component >6mm in a part-solid nodule, malignancy risk is very high — plan immediate biopsy or resection.",
    ...
    },
    {
        ...
        "etiologyEn": "Primary spontaneous: Apical bleb rupture (young, tall, thin male, smoking). Secondary spontaneous: COPD/emphysema, cystic fibrosis, Langerhans cell histiocytosis, LAM, Pneumocystis pneumonia. Traumatic: Blunt/penetrating chest trauma, rib fracture. Iatrogenic: Central venous catheter, thoracentesis, mechanical ventilation (barotrauma).",
        ...
        "differentialDiagnosisEn": ["Bullous Emphysema (Giant bulla, mimics pneumothorax — differentiate with CT)", "Pneumomediastinum (Mediastinal air, subcutaneous emphysema)", "Diaphragm Rupture (Trauma, abdominal organ herniation)", "Pleural Effusion (Opaque hemithorax, meniscus)", "Giant Bulla (Thin wall, normal surrounding parenchyma)"],
        ...
        "goldStandardEn": "CT thorax: Most sensitive method, detects small pneumothoraces. Chest X-ray (PA inspiratory): First-line diagnosis. USG (eFAST): Bedside emergency diagnosis, loss of lung sliding and lung point.",
        ...
        "clinicalPearlEn": "In supine patients, pneumothorax collects anteriorly → may not be visible on PA film → look for 'deep sulcus sign'. Absence of lung sliding + barcode sign + lung point on USG = Definitive pneumothorax diagnosis. Tension pneumothorax is a clinical diagnosis — do not wait for imaging, perform immediate needle decompression!",
    ...
    },
    {
        ...
        "etiologyEn": "Idiopathic: IPF (UIP pattern), NSIP, COP, AIP, DIP, RB-ILD, LIP. Autoimmune/connective tissue: Rheumatoid arthritis, scleroderma, SLE, dermatomyositis. Environmental/occupational: Hypersensitivity pneumonitis (bird fancier, farmer's lung), pneumoconioses (asbestosis, silicosis). Drug-induced: Methotrexate, amiodarone, bleomycin, nitrofurantoin.",
        ...
        "differentialDiagnosisEn": ["NSIP (Ground-glass predominant, little/no honeycombing, better prognosis)", "Hypersensitivity Pneumonitis (Upper/middle lobe, mosaic attenuation, antigen exposure)", "Sarcoidosis (Perilymphatic nodules, hilar LAP)", "Asbestosis (Asbestos history, pleural plaques, basal fibrosis)", "Drug-induced Pneumonitis (Drug history, improvement upon withdrawal)"],
        ...
        "goldStandardEn": "HRCT thorax (1-2mm thin section): UIP/NSIP/COP pattern recognition. Multidisciplinary evaluation (radiology + pulmonology + pathology): Definitive diagnosis. Surgical lung biopsy: When HRCT is indeterminate.",
        ...
        "clinicalPearlEn": "Basilar honeycombing + traction bronchiectasis + reticular opacity + minimal GGO on HRCT = UIP → IPF can be diagnosed without biopsy. If GGO predominant, consider NSIP — steroid response is better and prognosis is significantly better than UIP.",
    ...
    },
    {
        ...
        "etiologyEn": "Idiopathic (by definition, cause unknown). Risk factors: Smoking (strongest risk), advanced age (>60), male sex, gastroesophageal reflux (microaspiration), genetic predisposition (MUC5B, TERT mutations). Familial forms: Telomerase mutations.",
        ...
        "differentialDiagnosisEn": ["NSIP (GGO predominant, no/little honeycombing, basal/subpleural, better prognosis)", "Chronic Hypersensitivity Pneumonitis (Upper/middle lobe fibrosis, mosaic attenuation, antigen history)", "Asbestosis (Asbestos exposure, pleural plaques)", "Connective Tissue Disease-Associated ILD (Young woman, autoimmune markers)", "Drug-Induced Fibrosis (Amiodarone, bleomycin history)"],
        ...
        "goldStandardEn": "HRCT thorax: UIP pattern (definite, probable, indeterminate). ATS/ERS/JRS/ALAT 2022 guideline: Definite UIP pattern + clinical concordance = IPF diagnosis without biopsy. Surgical lung biopsy: In indeterminate HRCT pattern.",
        ...
        "clinicalPearlEn": "Elderly male + progressive dyspnea + dry cough + bilateral basal Velcro crackles + definite UIP pattern on HRCT = IPF diagnosis without biopsy. Median survival 3-5 years. Antifibrotic therapy (pirfenidone, nintedanib) slows progression but does not cure.",
    ...
    },
    {
        ...
        "etiologyEn": "Smoking (most important cause, 85-90%). Alpha-1 antitrypsin deficiency (young, lower lobe panacinar emphysema). Intravenous drug use (talc granulomatosis). Occupational exposure (cadmium, coal dust). Connective tissue diseases (Marfan, Ehlers-Danlos — paraseptal emphysema).",
        ...
        "differentialDiagnosisEn": ["Bronchiectasis (Dilated bronchi, signet ring, wall thickening)", "Langerhans Cell Histiocytosis (Upper lobe cysts, irregular shape, young smoker)", "Lymphangioleiomyomatosis — LAM (Young woman, diffuse thin-walled cysts)", "Pneumocystis Pneumonia (HIV, bilateral GGO + cysts)", "Honeycombing/UIP (Basal, subpleural, thick-walled cysts)"],
        ...
        "goldStandardEn": "HRCT thorax: Emphysema type (centrilobular, panacinar, paraseptal), distribution and severity. Inspiratory/expiratory CT: Air trapping assessment. PFT (Spirometry): FEV1/FVC <0.70 (obstructive pattern).",
        ...
        "clinicalPearlEn": "Centrilobular (upper lobe) = Smoking. Panacinar (lower lobe) = Alpha-1 antitrypsin deficiency → order alpha-1 antitrypsin level in emphysema <45 years! Paraseptal emphysema carries spontaneous pneumothorax risk. If PA diameter >29mm, consider cor pulmonale development.",
